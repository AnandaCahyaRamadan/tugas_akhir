                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="card-title d-flex align-items-center justify-content-between">
                                    <h5 class="text-nowrap mb-2">Jumlah Lagu Yang Dicover</h5>
                                    <div id="icons1" class="badge badge-center rounded-pill bg-label-primary">
                                        <i class='bx bxs-playlist bx-tada' ></i>
                                    </div>
                                </div>
                                <ul class="p-0 m-0">
                                    <li class="d-flex card-link1">
                                        <div
                                            ...
                                            <div class="me-2">
                                                <h6 class="mb-0 badge bg-label-success rounded-pill">Jumlah Lagu</h6>
                                            </div>
                                            <div class="user-progress d-flex align-items-center gap-1">
                                                <h6 class="mb-0">{{ $lagudicover}}</h6>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                ...
                <div class="row">
                    <div class="col-12 mb-4">
                        <div class="card">
                            <div class="card-body">
                                <div class="card-title d-flex align-items-center justify-content-between">
                                    <h5 class="text-nowrap mb-2">Jumlah Pengcover</h5>
                                    <div id="icons1" class="badge badge-center rounded-pill bg-label-primary">
                                ...
                                <ul class="p-0 m-0">
                                    <li class="d-flex card-link1">
                                        <div
                                            class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                            <div class="me-2">
                                                <h6 class="mb-0 badge bg-label-success rounded-pill">Jumlah Pengcover</h6>
                                            </div>
                                            <div class="user-progress d-flex align-items-center gap-1">
