...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <!-- Responsive Table -->
    <div class="card">
        <h5 class="card-header">Tambah Top Hits</h5>
        <hr class="my-0" />
        <form action="{{ route('tophits.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="form-group">
                        <div class="col mb-3">
                            ...
                            <input type="text" id="link" class="form-control @error('link') is-invalid @enderror"
                                name="link" placeholder="Masukkan link Lagu" value="{{ old('link') }}" autofocus />
                            @error('link')
